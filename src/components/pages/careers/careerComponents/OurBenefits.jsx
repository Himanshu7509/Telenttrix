...
const cardData = [
  {
    img: Img1,
    title: "Comprehensive health and welfare plans, along with other ancillary benefits, to help our employees maintain a healthy lifestyle.",
    borderColor: "border-b-[#fba91e]",
  },
  { img: Img2, title: "Artech offers a pension plan for our eligible employees to help them reach their long-term financial goals.", borderColor: "border-b-[#fba91e]" },
  { img: Img3, title: "We offer an internal training and reimbursement plan for individuals who would like to continue their education.", borderColor: "border-b-[#fba91e]" },
...
const OurBenefits = () => {
  return (
    <div className="flex flex-col items-center text-center p-6 md:p-12 bg-white justify-center w-full">
      <h2 className="text-2xl md:text-[26px] font-bold text-[#6c348d]">Our Benefits</h2>
      ...
      <p className="text-gray-700 max-w-4xl mt-4 text-sm md:text-base font-bold">
        ...
        hard-working industry professionals. We understand that there is more
        to life than work alone. Artech offers a host of benefits to eligible
        employees.
      </p>
      <div className="w-[80%] mt-12 mb-12">
